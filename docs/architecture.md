...
The VM, garbage collector, module loader, full access-control checker, structural interface conformance, traits, generic instantiation, arrays/maps, and richer patterns are intentionally reserved for the next milestones. Their syntax and AST seams are documented rather than faked by a transpiler.
